...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
                ...
                <div class="card card-dark">
                    ...
                    <form method="post" action="index.php" class="form-horizontal">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="icheck-primary d-inline mr-1">
                                        <input type="radio" id="seminar" name="jk" value="L">
                                        <label for="seminar">Seminar
                                        </label>
                                    </div>
                                    <div class="icheck-primary d-inline">
                                        <input type="radio" id="workshop" name="jk" value="P">
                                        <label for="workshop">Workshop
                                        </label>
                                    </div>
                                    <div class="icheck-primary d-inline">
                                        <input type="radio" id="event Olah Raga" name="jk" value="P">
                                        <label for="event Olah Raga">Event Olah Raga
                                        </label>
                                    </div>
                                    <div class="icheck-primary d-inline">
                                        <input type="radio" id="bazaar" name="jk" value="P">
                                        <label for="bazaar">Bazaar
                                        </label>
                                    </div>
                                    <div class="icheck-primary d-inline">
                                        <input type="radio" id="pelatihan" name="jk" value="P">
                                        <label for="pelatihan">Pelatihan
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="tgl_lahir">Tanggal Daftar</label>
                                <div class="col-sm-10">
                                    <input placeholder="Masukan Tanggal Daftar" autocomplete="off" type="text" name="tgl_lahir" id="tgl_lahir" class="form-control">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="alasan">Alasan Daftar</label>
                                <div class="col-sm-10">
                                    <input type="text" name="alasan" id="alasan" class="form-control" placeholder="Masukkan Alasan Daftar">
                                </div>
                            </div>
            ...
            $pasien_hardcode = ['kodePasien' => 'S-2022-VI-001', 'nama' => 'Jessica', 'jk' => 'Seminar', 'tgl_daftar' => '07-08-2022', 'email' => 'ingin kuliah di luar negeri','Action'];
            ...
            ?>
                <div class="card-body" id="hasil">
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Hasil Data Peserta</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    foreach ($all_pasien as $pasien) {
                                        ...
                                        echo '<td>' . $pasien['tgl_daftar'] . '</td>';
                                        echo '<td>' . $pasien['email'] . '</td>';
                                        // echo '<td>' . $pasien['tgl_daftar'] . '</td>';
                                        // echo '<td>' . $pasien['email'] . '</td>';
